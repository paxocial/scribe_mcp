...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_mcp_audit] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
