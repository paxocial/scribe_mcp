...
# 🔒 Security Log — scribe_sentinel_concurrency_v1
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: scribe_sentinel_concurrency_v1] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
