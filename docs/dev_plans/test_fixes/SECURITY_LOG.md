...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: test fixes] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
